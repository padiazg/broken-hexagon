...
var rootCmd = &cobra.Command{
	Use:   "broken-hexagon",
	Short: "broken-hexagon - Built with hexagonal architecture",
	Long: `broken-hexagon application generated by HexaGo.
...
func init() {
	...
	// Persistent flags
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is .broken-hexagon.yaml)")
}
